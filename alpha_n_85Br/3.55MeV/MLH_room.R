...
for (i in 1:10) {
  tempNorm = 1/(6.0+0.01*i)
  print(i)
  print(prob_observed(0.0019, 1.6491e-05, 1.00))
}
tempNorm = 1/2.1e2
prob_observed(0.00080, 2.000065e-05, 1.00)
...
fileName <- "~/Dropbox/Courses/R/alpha_n/alpha_n_85Br/3.55MeV/prob_dist_room.RData"
