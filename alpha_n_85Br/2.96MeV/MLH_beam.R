...
tempNorm = 1/2e2
prob_observed(0.0007320316, 1.915358e-05, 0.000000, 0.000000, 0.000001, 0, 0, 1.0, 1.0)

# starting values n1, n2, eff....
fileName <- "~/Dropbox/Courses/R/alpha_n/alpha_n_85Br/2.96MeV/prob_dist_room.RData"
load(file = fileName)
