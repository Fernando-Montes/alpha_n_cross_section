...
beam_ratio = (439870800/29036)/(116691400/7195) # ratio of beam intensity between gas in and gas out runs
...
factorCS = 7255808/(439870800*5.93e-8) # convert rate to mbarn
...
tempNorm = 1/1.5e2
prob_observed( 0.0007313932, 1.843006e-05, 4.052037e-06, 2.501411e-07, 1.630474e-06, 0, 0, 0.000150, 0.000070, 1,  1, 0.22 )
...
fileName <- "~/Dropbox/Courses/R/alpha_n/alpha_n_85Br/2.96MeV/prob_dist_beam.RData"
load(file = fileName)
