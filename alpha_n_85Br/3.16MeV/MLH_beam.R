...
tempNorm = 1/1.e3
prob_observed(0.0007964115, 2.084418e-05, 0.000010, 0.000005, 0.000001, 0, 0, 1.0, 1.0)

# starting values n1, n2, eff....
fileName <- "~/Dropbox/Courses/R/alpha_n/alpha_n_85Br/3.16MeV/prob_dist_room.RData"
load(file = fileName)
