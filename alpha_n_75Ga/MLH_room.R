...
# temp = prob_dist[prob_dist$prob > 10^6,]
# plot_ly(x = temp$n1, y = temp$eff)

plot_ly(data = prob_dist, x = ~n1, y = ~eff, color = ~prob, size = ~prob)
...
fileName <- "~/Dropbox/Courses/R/alpha_n/prob_dist_eff_n1_n2.RData"
