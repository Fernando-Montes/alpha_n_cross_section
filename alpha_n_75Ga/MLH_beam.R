...
norma = 12718    # Term to normalize since the numbers are VERY small!
l = 1271800/norma
m1 = 4556/norma
m2 = 676/norma
m3 = 115/norma
...
prob_observed(0.00734237, 0.0004252972, 0.0004216345, 2.546153e-05, 0.00288984, 0.0001975177, 0, 0.2733335, 0.2733335)
...
fileName <- "~/Dropbox/Courses/R/alpha_n/prob_dist_eff_room.RData"
load(file = fileName)
...
ptime <- system.time({
  ...
  ind = rownames(prob_dist_n1_n2[prob_dist_n1_n2$eff<0.28,])
  for (k in 1:10000) {
