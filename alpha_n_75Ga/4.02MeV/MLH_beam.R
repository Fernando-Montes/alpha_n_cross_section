...
tempNorm = 1/18.58
prob_observed(0.002174047, 3.007543e-05, 0.001374947, 0.0004969205, 9.056707e-05, 0, 0, 1.0, 1.0)

# starting values n1, n2, eff....
fileName <- "~/Dropbox/Courses/R/alpha_n/4.02MeV/prob_dist_room.RData"
load(file = fileName)
