...
tempNorm = 1/9.0e5
prob_observed(0.00222451, 3.122231e-05, 0.0008031316, 0.00012582, 1.311244e-05, 0, 0, 1.0, 1.0)
...
fileName <- "~/Dropbox/Courses/R/alpha_n/3.14MeV/prob_dist_beam.RData"
save(prob_dist, file = fileName)

load("/Users/fernandomontes/Dropbox/Courses/R/alpha_n/3.14MeV/prob_dist_beam.RData")
