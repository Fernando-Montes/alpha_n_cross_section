...
norma = 212573    # Term to normalize since the numbers are VERY small!
l = 90768671/norma
m1 = 417704/norma
m2 = 20019/norma
m3 = 4886/norma
...
tempNorm = 1/8.6934e5
prob_observed(0.007320971, 0.0004796114, 0.0009103931, 0, 5.611639e-05, 0.0005931847, 2.496351e-07, 0.006491719, 0.0008888211, 0.2648121, 0.2921295, 0.2207896)
...
ptime <- system.time({
  ...
  ind = rownames(prob_dist_beam[prob_dist_beam$effb<0.3,])
...
library(gplots)
est <- ci2d(prob_dist$a1*factorCS, prob_dist$a2*factorCS, show="contour", col="black", show.points = TRUE)
