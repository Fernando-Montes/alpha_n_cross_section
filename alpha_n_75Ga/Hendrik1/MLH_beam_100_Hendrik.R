...
norma = 89515    # Term to normalize since the numbers are VERY small!
l = 90947240/norma
m1 = 241686/norma
m2 = 17611/norma
m3 = 4748/norma
m0 = l-m1-m2-m3  #891472
...
prob_observed(0.00723197, 0.0004637409, 0.000948607,  0, 3.794304e-05, 0.0006076045, 1.434006e-05, 0.2686218, 0.281705)
...
fileName <- "~/Dropbox/Courses/R/alpha_n/Hendrik/prob_dist_room_100_Hendrik.RData"
load(file = fileName)
prob_dist_n1_n2 = prob_dist[prob_dist$prob > 0.001,]
...
fileName <- "~/Dropbox/Courses/R/alpha_n/Hendrik/prob_dist_beam_100_Hendrik.RData"
save(prob_dist, file = fileName)
# load("~/Dropbox/Courses/R/alpha_n/Hendrik/prob_dist_beam_100_Hendrik.RData")
