...
prob_observed(0.007882068, 0.0005627925, 0.2433977)
...
maxP = max(prob_dist$prob)
prob_dist = prob_dist[prob_dist$prob > 0.01*maxP,]
...
fileName <- "~/Dropbox/Courses/R/alpha_n/prob_dist_room_100_Hendrik.RData"
